...
function [ INL, voltage_step, ADC_fit ]=getINL( ADC_act_bin, fit_type, N, voltages_to_chip )
...
%% Y shift to bring INL to within +1 1 LSB
voltage_step_shift = volt_LSB * 0.69 ;
voltage_step = voltage_step - voltage_step_shift ;
...
%% HELPER FUNCTIONS
%%
function mapped_bin = ADC_map_fn( actual_bin, ADC_fit, N )
    max_val = (2^N)-1;
    mapped_bin = min( max( 0, ADC_fit( actual_bin ) ), max_val ) ;
