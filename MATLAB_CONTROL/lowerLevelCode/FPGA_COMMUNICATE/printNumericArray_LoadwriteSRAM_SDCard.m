function printNumericArray_LoadwriteSRAM_SDCard(fileHandle, numArray)
% display( mfilename )
...
%     returnedData = sendNumericArray( fileHandle, numArray, numSentBytesAtATime ) ;
    returnedData = sendNumericArraySafe_LoadwriteSRAM_SDCard( fileHandle, numArray, numSentBytesAtATime ) ;
