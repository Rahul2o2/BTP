function returnedData = printNumericArray_adcRead_BLsRefs_returnVoltages(fileHandle, numArray, repeatAvg, bitLines, refs_cycle  )
% display( mfilename )
...
%  - fileHandle.fH is a fileHandle for the receive file
    ...
    while( success ~= 1 )
        [ returnedData, success ] = sendNumericArray_adcRead_BLsRefs( fileHandle, numArray, numSentBytesAtATime, repeatAvg, bitLines, refs_cycle  ) ;
    end
