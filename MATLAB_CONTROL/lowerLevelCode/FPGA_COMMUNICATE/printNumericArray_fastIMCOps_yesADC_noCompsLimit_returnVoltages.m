function returnedData = printNumericArray_fastIMCOps_yesADC_noCompsLimit_returnVoltages( fileHandle, numArray, repeatAvg, numComparisions_total )
% display( mfilename )
...
%  - fileHandle.fH is a fileHandle for the receive file
    ...
    while( success ~= 1 )
        [ returnedData, success ] = sendNumericArray_fastIMCOps_yesADC_noCompsLimit( fileHandle, numArray, numSentBytesAtATime, repeatAvg, numComparisions_total  ) ;
    end
