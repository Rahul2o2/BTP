function [ returnString, wlstatus, wscstatus, array_data ] = write_onto_dataLines( fileHandle, colSel, data_DL, DL_nums, wlstatus, wscstatus, array_data, startStringIn )
