...
% output voltage attempts to go over the specified over-voltage limit(specified in AgB2902A_2_configureVoltageLimit.m)
% 
function AgB2902A_2_configureOVPbehaviour( instrumentObj, outputTarget, behaviour )
display( mfilename )
