...
function instrumentObj = AgB2902A_2_connect()
display( mfilename )
% From the Keysight IO Connection Expert Software got these details:
serial_number = 'MY51142814' ;
...
makemid( 'AgB29xx', 'AgB2902A.mdd' ) ; % Got this from https://www.keysight.com/in/en/lib/software-detail/driver/b2900a-precision-source-measure-unit-ivi-and-matlab-instrument-drivers-2056761.html
...
instrumentObj = icdevice( 'AgB2902A.mdd', INSTRU_ID ) ;
