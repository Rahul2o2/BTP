...
% What happens when the output voltage crosses the limit depends on the setting of AgB2902A_configureOVPLimitbehaviour for CURRENT SOURCE
...
function AgB2902B_configureVoltageLimitUpLow( instrumentObj, outputTarget, voltageLimit )
display( mfilename )
...
%instrumentObj.WriteString(":SOUR:VOLT:RANG:AUTO ON")
%instrumentObj.WriteString(":SOUR:VOLT:RANG:AUTO:LLIM 2") %’2 V range limit
