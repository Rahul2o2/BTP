...
% Call this function only after you have called AgE36313A_2_configure() to
% set it to a known, SAFE, voltage level at
% This Function turns OFF the chosen output of the voltage source at
% whatever voltage it was configured to in AgE36313A_2_configure()
...
function AgE36313A_2_disable( instrumentObj, outputTarget )
display( mfilename )
