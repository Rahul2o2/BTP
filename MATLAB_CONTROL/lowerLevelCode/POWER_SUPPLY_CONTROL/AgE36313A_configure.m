...
%1% makemid( 'AgE36xx', 'AgE36313A_2.mdd' ) ; % Got this from https://www.keysight.com/in/en/lib/software-detail/driver/e36xx-e36xxx-dc-power-supply-ivi-and-matlab-instrument-drivers-1669314.html
%2% INSTRU_ID = 'USB0::0x2A8D::0x1202::MY59003914::0::INSTR' ; % Got this by running keysight connection expert after connecting the power supply to the PC
%3% instrumentObj = icdevice( 'AgE36313A_2.mdd', INSTRU_ID ) ;
...
function AgE36313A_configure( instrumentObj, outputTarget, voltageLevel )
