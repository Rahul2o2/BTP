...
% makemid( 'AgE36xx', 'AgE36313A.mdd' ) ; % Got this from https://www.keysight.com/in/en/lib/software-detail/driver/e36xx-e36xxx-dc-power-supply-ivi-and-matlab-instrument-drivers-1669314.html
makemid( 'AgRfSigGen', 'N5173B.mdd' ) ;
...
instrumentObj = icdevice( 'N5173B.mdd', INSTRU_ID ) ;
