///*
// * resnet20_CONV2_L23_FX_2bitX_XADC.c
// *
...
//	uint16_t XBL = mode_xbit; // XBL is the number of image pxl mantissa bits being fed
...
//			currObj = convolve_FP_2bit_XADC(&X_Mat[b],mini_batch_size,X_Channels,X_Height,X_Width ,X_Padding[Layer_ID][0],X_Stride[Layer_ID][0],W_Mat,W_Batch[Layer_ID],W_Channels[Layer_ID],W_Height[Layer_ID],W_Width[Layer_ID],
//							W_Padding, W_Stride, WordLines[Layer_ID], XDL, XBL, WDL, WBL, IMC, Bias,Ref,RefB,RefMax,XMAX_Data[Layer_ID],WMAX_Data[Layer_ID],&CNV_Out1[b],mode,slopeSetting,mode_xbit,currObj);
