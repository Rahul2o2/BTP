...
////	uint16_t X_Batch_manual = 1408 ;
////	uint16_t X_Batch_manual = 32 ;
//	uint16_t X_Batch_manual = 528 ;
...
//		mode.I_mean=8.141112388888877e-07; // load('D:\Xilinx\Vivado_2018_Projs\IMC_CHIP_2023\PCB_v3\MATLAB_CONTROL\Control_Codes\Testing\017_ReadStackAlphaMeasurement\AlphaMeasure_RWL474mV\alphaStored\NEWalphas.mat', 'ImeanNew_DLStore')
//		mode.slopecorrect=1;
//		mode.slopecorrect_chip=0.9439;// from D:\Xilinx\Vivado_2018_Projs\IMC_CHIP_2023\PCB_v3\MATLAB_CONTROL\Control_Codes\Testing\032_SystemMAC_DryRuns_ASHWIN\cifar100R20\CONV2_66_L23_FX\2_INTERNAL_XADC_floatFix\xm11\LAYER1_then_LAYER2_XADC\DP_MAC_RX.m
//		mode.slopecorrect_XADC=1;
//	// method1: batched (starts)
//		int mini_batch_size_lim=8;//mini batch size search
//		int mini_batch_size=( X_Batch > mini_batch_size_lim ? mini_batch_size_lim : X_Batch );
