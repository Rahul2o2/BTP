...
//		mode.I_mean=8.141112388888877e-07; // load('D:\Xilinx\Vivado_2018_Projs\IMC_CHIP_2023\PCB_v3\MATLAB_CONTROL\Control_Codes\Testing\017_ReadStackAlphaMeasurement\AlphaMeasure_RWL474mV\alphaStored\NEWalphas.mat', 'ImeanNew_DLStore')
//		mode.slopecorrect=1;
//		mode.slopecorrect_chip=0.9483;
...
//		mode.I_mean=8.141112388888877e-07; // load('D:\Xilinx\Vivado_2018_Projs\IMC_CHIP_2023\PCB_v3\MATLAB_CONTROL\Control_Codes\Testing\017_ReadStackAlphaMeasurement\AlphaMeasure_RWL474mV\alphaStored\NEWalphas.mat', 'ImeanNew_DLStore')
//		mode.slopecorrect=1;
//		mode.slopecorrect_chip=1;// from D:\Xilinx\Vivado_2018_Projs\IMC_CHIP_2023\PCB_v3\MATLAB_CONTROL\Control_Codes\Testing\032_SystemMAC_DryRuns_ASHWIN\cifar100R20\CONV2_66_L23_FX\2_INTERNAL_XADC_floatFix\xm11\LAYER1_then_LAYER2_XADC\DP_MAC_RX.m
//		mode.slopecorrect_XADC=1;
//	// method1: batched (starts)
//		int mini_batch_size_lim=8;//mini batch size search
//		int mini_batch_size=( X_Batch > mini_batch_size_lim ? mini_batch_size_lim : X_Batch );
//		for( int b=X_Batch_start; b<X_Batch; b+=mini_batch_size ){
//		currObj = convolve_FP_XADC(&CNV_Out1[b],mini_batch_size,W_Batch[Layer_ID - 1],X_out_h2 ,X_out_w2,X_Padding[Layer_ID][0],X_Stride[Layer_ID][0],W_Mat,W_Batch[Layer_ID],W_Channels[Layer_ID],W_Height[Layer_ID],W_Width[Layer_ID],
...
////		add4DArrayElementwise(CNV_Out2,X_Mat, X_Batch,X_Channels,X_Height,X_Width);
////	//perform ReLU here
