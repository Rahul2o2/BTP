...
//			currObj = convolve_XADC(&X_Mat[b]   ,mini_batch_size,X_Channels           ,X_Height         ,X_Width ,X_Padding[Layer_ID][0],X_Stride[Layer_ID][0],W_Mat,W_Batch[Layer_ID],W_Channels[Layer_ID],W_Height[Layer_ID],W_Width[Layer_ID],
