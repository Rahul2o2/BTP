...
//				int mini_batch_size=( X_Batch > mini_batch_size_lim ? mini_batch_size_lim : X_Batch );
//			for( int b=0; b<X_Batch; b+=mini_batch_size ){
//			currObj = convolve_XADC(&CNV_Out3[b],mini_batch_size,W_Batch[Layer_ID - 1],X_out_h3         ,X_out_w3,X_Padding[Layer_ID][0],X_Stride[Layer_ID][0],W_Mat,W_Batch[Layer_ID],W_Channels[Layer_ID],W_Height[Layer_ID],W_Width[Layer_ID],
