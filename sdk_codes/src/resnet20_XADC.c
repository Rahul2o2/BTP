...
////			// method1: batched (ends)
////			// method2: all at once (starts)
////	//	currObj = convolve_NotOnChip(CNV_Out1,X_Batch,W_Batch[Layer_ID - 1],X_out_h1,X_out_w1,X_Padding[Layer_ID][0],X_Stride[Layer_ID][0],W_Mat,W_Batch[Layer_ID],W_Channels[Layer_ID],W_Height[Layer_ID],W_Width[Layer_ID],
////	//					W_Padding, W_Stride, WordLines[Layer_ID], XDL, XBL, WDL, WBL, IMC, Bias,Ref,RefB,RefMax,CNV_Out2,currObj);
////	}
////	// CONVOLUTION LAYER ENDS
////	//Deallocate Bias Mat
////	free(Bias);
...
////
////
//////	for(uint16_t i = 0; i < 4; i= i+2){
//////		currObj = convolve_NotOnChip(&X_Mat[i],2,X_Channels,X_Height,X_Width,X_Padding[Layer_ID][0],X_Stride[Layer_ID][0],W_Mat,W_Batch[Layer_ID],W_Channels[Layer_ID],W_Height[Layer_ID],W_Width[Layer_ID],
//////				W_Padding, W_Stride, WordLines[Layer_ID], XDL, XBL, WDL, WBL, IMC, Bias,Ref,RefB,RefMax,&CNV_Out1[i],currObj);
//////	}
////	currObj = convolve_NotOnChip(CNV_Out2,X_Batch,W_Batch[Layer_ID-1],X_out_h2,X_out_w2,X_Padding[Layer_ID][0],X_Stride[Layer_ID][0],W_Mat,W_Batch[Layer_ID],W_Channels[Layer_ID],W_Height[Layer_ID],W_Width[Layer_ID],
////					W_Padding, W_Stride, WordLines[Layer_ID], XDL, XBL, WDL, WBL, IMC, Bias,Ref,RefB,RefMax,CNV_Out3,currObj);
////   //Deallocate Bias Mat
////   free(Bias);
////
////   //Deallocate Weight Matrix
...
//////				W_Padding, W_Stride, WordLines[Layer_ID], XDL, XBL, WDL, WBL, IMC, Bias,Ref,RefB,RefMax,&CNV_Out1[i],currObj);
//////	}
////	currObj = convolve_NotOnChip(CNV_Out3,X_Batch,W_Batch[Layer_ID - 1],X_out_h3,X_out_w3,X_Padding[Layer_ID][0],X_Stride[Layer_ID][0],W_Mat,W_Batch[Layer_ID],W_Channels[Layer_ID],W_Height[Layer_ID],W_Width[Layer_ID],
////					W_Padding, W_Stride, WordLines[Layer_ID], XDL, XBL, WDL, WBL, IMC, Bias,Ref,RefB,RefMax,CNV_Out4,currObj);
////	//Deallocate Bias Mat
////	free(Bias);
////
////	//Deallocate Weight Matrix
...
////
////	uint16_t pool_paddedHeight = X_out_h2 + 2 * M_Padding[0][0]; //Padding is zero
////	uint16_t pool_paddedWidth = X_out_w2 + 2 * M_Padding[0][1]; // Padding is zero
...
////
////	float**** POOL_Out1 = (float****)calloc(X_BitMat_Batch2,sizeof(float***));
////	for(uint16_t b = 0; b < X_BitMat_Batch2; b++){
////		POOL_Out1[b] = (float***)calloc(W_BitMat_Batch2,sizeof(float**));
////		for(uint16_t c = 0; c < W_BitMat_Batch2; c++){
...
////	}
////
////	AvgPooling(CNV_Out2, X_Batch,W_Batch[Layer_ID],X_out_h2,X_out_w2, M_KSize[0][0], M_KSize[0][1],M_Padding[0][0],
...
////		u32 SourceAddress;
////		{
////			float size_params[]={X_Batch,W_Batch[Layer_ID]*Pool_out_h1*Pool_out_w1};
////			int size_params_size=sizeof( size_params ) ;
